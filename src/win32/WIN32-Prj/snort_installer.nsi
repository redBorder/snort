; $Id: snort_installer.nsi,v 1.74 2015/07/06 19:54:21 cwaxman Exp $
;
; NSIS Installation script for Snort 2.9.7.5 Win32
; Written by Chris Reid <chris.reid@codecraftconsultants.com>
; Updated by Steven Sturges <ssturges@sourcefire.com>
;
; This script will create a Win32 installer for Snort 2.9.7.5 (Win32 only).
...
;Configuration
  ...
  ;General
  OutFile "Snort_2_9_7_5_Installer.exe"  ; The name of the installer executable
